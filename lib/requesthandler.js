...
function RequestHandler() {
  ...
  this.root = function(request, response) {
    ...
    response.write('POST to /collection to create a new document (collection '
        + 'is generated on the fly, if it does not exist yet),\n')
  ...
  this.list = function(request, response, collection) {
    // TODO Return 404 if collection does not yet exist.
    var first = true
